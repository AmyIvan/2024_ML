...
parser.add_argument('--root_path', type=str, default='/home/ymai/2024_ML/my_model/long/data/ML/', help='root path of the data file')
...
parser.add_argument('--pred_len', type=int, default=240, help='prediction sequence length')
